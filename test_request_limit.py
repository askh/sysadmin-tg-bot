...
class RequestLimitTest(unittest.IsolatedAsyncioTestCase):
    ...
    def test_create(self):
        ...
        rl = RequestLimit(max_value, max_id_value, time_interval_sec)
        self.assertEqual(max_value, rl.max_value)
